        ...
        <div class="container">
        	...
        	<div class="col-lg-8">
        		<div class="sticky">
	        		<div class="card">
	        			<div class="card-body">
	        				<div class="row">
		        				<div class="col-md-8"><b>Carrito</b></div>
	        		...
	        		<div class="card-body">
		        		<div class="row">
			        		...
			        		<div class="col-md-4">
			        			...
			        			<p><b><small>Precio: <?php echo number_format($row['price'],2) ?></small></b></p>
			        			<p><small></small></p>
        	...
        	<div class="col-md-4">
        		<div class="sticky">
        			<div class="card">
        				<div class="card-body">
        					<p><large>Total a Pagar </large></p>
        					<hr>
        					<p class="text-right"><b><?php echo number_format($total,2) ?></b></p>
        					<hr>
        					<div class="text-center">
        						<button class="btn btn-block btn-outline-primary" type="button" id="checkout">CONFIRMAR</button>
        					</div>
        				</div>
        			</div>
        		</div>
